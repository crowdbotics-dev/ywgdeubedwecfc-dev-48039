...
## Project Structure
    ...
    ├── ywgdeubedwecfc_dev_48039  # Django project configurations
...
1. Clone this repo and `cd ywgdeubedwecfc_dev_48039`
...
2. Clone this repo and `cd ywgdeubedwecfc_dev_48039`
